"""
Auto-generated component for: Stock Picker
Created: 2026-01-09T23:58:12.656937
User ID: 974a39d3-3108-4e8a-a777-1ac44b87b17c
Component ID: f7cd711b-8001-4b33-ae59-7e88778490d0
...
class StockPickerAgent_f7cd711b(Component):
    ...
    inputs = [
        ...
        MessageTextInput(
            ...
            info="Enter your message or question for Stock Picker",
            tool_mode=True,
        ),
        ...
        HandleInput(
            ...
            is_list=True,
            info="Tools that Stock Picker can use to help answer questions",
        ),
