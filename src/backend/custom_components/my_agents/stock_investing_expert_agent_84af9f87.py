"""
Auto-generated component for: Stock Investing Expert
Created: 2026-01-09T23:48:30.593758
User ID: 974a39d3-3108-4e8a-a777-1ac44b87b17c
Component ID: 84af9f87-cfa0-426f-9f13-92406ef28f7c
...
class StockInvestingExpertAgent_84af9f87(Component):
    """Created from Q&A wizard"""

    display_name = "Stock Investing Expert"
    description = "Created from Q&A wizard"
    icon = "dog"
    name = "StockInvestingExpertAgent_84af9f87"
    ...
    inputs = [
        ...
        MessageTextInput(
            ...
            info="Enter your message or question for Stock Investing Expert",
            tool_mode=True,
        ),
        ...
        MultilineInput(
            ...
            info="Instructions that define how Stock Investing Expert behaves",
            value="""You are You look up the price of stocks and say if its a good buy or not..\n\n## Your Rules and Knowledge\nYou always find the latest price of stocks.\n\n## Important Guidelines\n- Always stay in character as described above\n- Be helpful, friendly, and professional\n- If you don't know something, admit it honestly\n- Keep responses concise but informative\n- Ask clarifying questions when needed\n- Use your available tools when they can help answer questions\n\n## Your Tools\nYou have access to the following tools:\n- DuckDuckGo Search: Search the web using DuckDuckGo with customizable result limits\nUse these tools when appropriate to provide accurate, up-to-date information.""",
        ),
        ...
        HandleInput(
            ...
            is_list=True,
            info="Tools that Stock Investing Expert can use to help answer questions",
        ),
