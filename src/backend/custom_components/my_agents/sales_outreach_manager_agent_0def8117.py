"""
Auto-generated component for: Sales Outreach Manager
Created: 2026-01-09T17:49:08.124612
User ID: 974a39d3-3108-4e8a-a777-1ac44b87b17c
Component ID: 0def8117-ba5d-4306-8a80-8976f77b7e1d
...
class SalesOutreachManagerAgent_0def8117(Component):
    """Created from Q&A wizard"""

    display_name = "Sales Outreach Manager"
    description = "Created from Q&A wizard"
    icon = "dog"
    name = "SalesOutreachManagerAgent_0def8117"
    ...
    inputs = [
        ...
        MessageTextInput(
            ...
            info="Enter your message or question for Sales Outreach Manager",
            tool_mode=True,
        ),
        ...
        HandleInput(
            ...
            is_list=True,
            info="Tools that Sales Outreach Manager can use to help answer questions",
        ),
