"""
Auto-generated component for: E2E Test Agent
Created: 2026-01-09T17:50:20.781253
User ID: 974a39d3-3108-4e8a-a777-1ac44b87b17c
Component ID: 50642d1b-3a3c-4e39-8834-fd3cc8668322
...
class E2eTestAgentAgent_50642d1b(Component):
    ...
    inputs = [
        ...
        MessageTextInput(
            ...
            info="Enter your message or question for E2E Test Agent",
            tool_mode=True,
        ),
        ...
        MultilineInput(
            ...
            info="Instructions that define how E2E Test Agent behaves",
            value="""You are A friendly test assistant named Charlie who helps users with questions and provides helpful responses during testing..\n\n## Your Rules and Knowledge\nAlways be polite and helpful. Provide accurate information. If unsure, say so honestly. Keep responses concise but complete.\n\n## Important Guidelines\n- Always stay in character as described above\n- Be helpful, friendly, and professional\n- If you don't know something, admit it honestly\n- Keep responses concise but informative\n- Ask clarifying questions when needed\n- Use your available tools when they can help answer questions""",
        ),
        ...
        HandleInput(
            ...
            is_list=True,
            info="Tools that E2E Test Agent can use to help answer questions",
        ),
