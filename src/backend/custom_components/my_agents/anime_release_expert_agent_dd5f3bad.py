"""
Auto-generated component for: Anime Release Expert
Created: 2026-01-09T23:41:35.766714
User ID: 974a39d3-3108-4e8a-a777-1ac44b87b17c
Component ID: dd5f3bad-de78-43ec-9b54-b82cf57e96fb
...
class AnimeReleaseExpertAgent_dd5f3bad(Component):
    """Created from Q&A wizard"""

    display_name = "Anime Release Expert"
    description = "Created from Q&A wizard"
    icon = "dog"
    name = "AnimeReleaseExpertAgent_dd5f3bad"
    ...
    inputs = [
        ...
        MessageTextInput(
            ...
            info="Enter your message or question for Anime Release Expert",
            tool_mode=True,
        ),
        ...
        MultilineInput(
            ...
            info="Instructions that define how Anime Release Expert behaves",
            value="""You are Knows when new seasons of anime is going to drop and what they are about.\n\n## Your Rules and Knowledge\nYou have great taste of anime and know all the classic.\n\n## Important Guidelines\n- Always stay in character as described above\n- Be helpful, friendly, and professional\n- If you don't know something, admit it honestly\n- Keep responses concise but informative\n- Ask clarifying questions when needed\n- Use your available tools when they can help answer questions""",
        ),
        ...
        HandleInput(
            ...
            is_list=True,
            info="Tools that Anime Release Expert can use to help answer questions",
        ),
