...
import type { ChatMessage, WorkflowConversation, AgentComponent } from '@/types'
...
export function PlaygroundPage() {
  ...
  const resolvedAgentComponent = isWorkflowMode ? workflowAgentComponent : agentComponent
  ...
  return (
    <div className="flex h-full">
        ...
        <div className="flex-shrink-0 border-b border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {editAgentComponentId && resolvedAgentComponent && (
                isPublished(editAgentComponentId) ? (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-white bg-gradient-to-r from-violet-500 to-purple-600 rounded-lg opacity-80 cursor-default">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-white bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 rounded-lg transition-all hover:shadow-lg hover:shadow-violet-500/25"
                  >
      ...
      {entity && chatWorkflow && (
        <ShareDeployModal
          agent={{ ...entity, langflow_flow_id: chatWorkflow.langflow_flow_id } as AgentComponent & { langflow_flow_id: string }}
      ...
      {/* Publish Agent Modal */}
      {resolvedAgentComponent && (
        <PublishAgentModal
          agent={resolvedAgentComponent}
